...
const LANGUAGE_STRINGS = {
    en: {
        MENU_CHOICE_1: "Play Game",
        MENU_CHOICE_2: "Settings",
        MENU_CHOICE_3: "Exit Game",
        PLAY_AGAIN_QUESTION: "Do you want to play again? (y/n)",
        WINNER_MESSAGE: "Winner is player ",
        DRAW_MESSAGE: "It's a draw!"
    },
    no: {
        MENU_CHOICE_1: "Spill",
        MENU_CHOICE_2: "Innstillinger",
        MENU_CHOICE_3: "Avslutt",
        PLAY_AGAIN_QUESTION: "Vil du spille igjen? (j/n)",
        WINNER_MESSAGE: "Vinneren er spiller ",
        DRAW_MESSAGE: "uavgjort"
    }
};
...
function evaluateGameState() {
    ...
    // Check diagonal wins
    let diagonal1Sum = gameboard[0][0] + gameboard[1][1] + gameboard[2][2];
    let diagonal2Sum = gameboard[0][2] + gameboard[1][1] + gameboard[2][0];
